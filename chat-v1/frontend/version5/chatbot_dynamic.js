document.addEventListener("DOMContentLoaded", function () {
    ...
    async function sendMessage() {
        ...
        try {
            ...
            ttsLoadingElement.style.alignSelf = "flex-start";
            ttsLoadingElement.style.backgroundColor = "#e0e0e0";
            ttsLoadingElement.style.color = "black";
            ttsLoadingElement.style.padding = "8px";
            ttsLoadingElement.style.borderRadius = "5px";
            ttsLoadingElement.style.margin = "10px 0";
